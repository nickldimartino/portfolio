      ...
      <div>
        {EXPERIENCES.map((experience, index) => (
          <div key={index} className="mt-12 mb-8 flex flex-wrap lg:justify-center">
            ...
            >
              <p className="mb-2 text-sm text-neutral-500 font-semibold">{experience.year}</p>
            </motion.div>
            <motion.div
              whileInView={{ opacity: 1, x: 0 }}
              initial={{ opacity: 0, x: 100 }}
            ...
            >
              <h6 className="mb-2 font-semibold">
                {experience.role} -{" "}
                <a href={experience.companyWebsite} target="_blank"className="text-sm text-blue-500 hover:underline">
                  {experience.company}
                </a>
              </h6>
              <ul>
